...
def cases(test_data):
    """Decorator to provide access to many tests cases data"""
...
class TestSuite(unittest.TestCase):
    ...
    def get_response(self, request):
        ...
        return method_handler(
            request=request, headers=self.headers, context=self.context
        )
    ...
    def test_invalid_method_request(self, request):
        """Tests if requested method is invalid for Scoring API"""
    ...
    def test_invalid_score_request(self, arguments):
        """Tests if score request is invalid"""
    ...
    def test_ok_score_request(self, arguments):
        """Tests if valid score request passes"""
    ...
    def test_invalid_interests_request(self, arguments):
        """Tests if interests request is invalid"""
